-- Inventario Casa del Marqués
-- Prefijo de tablas: casa_marques_  (DB_PREFIX en .env)
-- Cotejamiento: utf8mb4_unicode_ci (tildes y diéresis: áéíóúüñ)
-- Zona horaria: America/Bogota (UTC-05:00)
--
-- Preferible ejecutar: php database/install.php
-- Este archivo coincide con el prefijo actual de .env.
